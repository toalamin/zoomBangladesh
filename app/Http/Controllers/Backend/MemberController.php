...
class MemberController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'phone' => 'required|unique:members|max:20',
            'facebook' => 'nullable|unique:members|max:100',
            'linked' => 'nullable|unique:members|max:100',
            'instagram' => 'nullable|unique:members|max:100',
