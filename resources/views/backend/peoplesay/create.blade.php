...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb pull-right">
            <li>
                <a title="Add New People" class="financeAddPermission btn btn-sm btn-success" href="{{ route('people.index') }}">
    ...
    <div class="row">
        <br>
        <div class="col-md-12">
            <form action="{{ route('people.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
