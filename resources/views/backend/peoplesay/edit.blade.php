...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>Setup</li>
            <li class="active">Edit People Say</li>
        </ul>
        <ul class="breadcrumb pull-right">
            <li>
                <a title="Add New Slider" class="financeAddPermission btn btn-sm btn-success" href="{{ route('people.index') }}">
    ...
    <div class="row">
        <br>
        <div class="col-md-12">
            <form action="{{ route('people.update',$people->id ) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}

                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Name <span style="color:red!important"> *</span></label>
                    <div class="col-sm-8">
                        <input type="text" value="{{ $people->name  }}" name="name" class="form-control  " placeholder="Name" />
                        @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" value="{{ $people->designation  }}" name="designation" class="form-control  " placeholder="Designation" />
                        @error('designation')
                        <div class="alert alert-danger">
                            <button type="button" class="close" data-dismiss="alert">
                                <i class="ace-icon fa fa-times"></i>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                    <textarea class="ckeditor form-control" name="description">{{ $people->description }}</textarea>
                        @error('description')
                        <div class="alert alert-danger">
                            <button type="button" class="close" data-dismiss="alert">
                                <i class="ace-icon fa fa-times"></i>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="hidden" value="{{ $people->image }}" name="old_image" class="form-control" />
                        <img src="frontant/people/{{ $people->image}}" height="50px" width="50px" />
                        @error('file')
                        <div class="alert alert-danger">
                            <button type="button" class="close" data-dismiss="alert">
                                <i class="ace-icon fa fa-times"></i>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" name="status">
                            <option @if($people->visibility == 1) selected @endif; value="1">Visible (it will be show)</option>
                            <option @if($people->visibility == 2) selected @endif; value="2">Invisisble(it will be hide)</option>
                        </select>
                        <!-- <div  class="alert alert-danger">
                                    <button type="button" class="close" data-dismiss="alert">
                                        <i class="ace-icon fa fa-times"></i>
