...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb pull-right">
            <li>
                <a title="Add New Slider" class="financeAddPermission btn btn-sm btn-success" href="{{ route('notice.create') }}">
                ...
                <table id="example" class="table table-striped table-bordered table-hover" style="width:100%!important">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('uploads/notice/'.$value->image) }}" height="50px" width="50px" /></td>
                            <td>
                            ...
                            <td nowrap>
                                <form action="{{ route('notice.destroy',$value->id) }}" method="POST">
                                    <a class="btn btn-xs btn-success blue" href="{{ route('notice.edit',$value->id) }}">
