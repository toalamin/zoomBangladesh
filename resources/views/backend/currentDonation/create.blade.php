...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>Setup</li>
            <li class="active">Add Current Donation</li>
        </ul>
        <ul class="breadcrumb pull-right">
            <li>
                <a title="Add New fundraise" class="financeAddPermission btn btn-sm btn-success" href="{{ route('current.index') }}">
    ...
    <div class="row">
        <br>
        <div class="col-md-12">
            <form action="{{ route('current.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <textarea   maxlength="500" value="{{ old('description') }}" name="description" class="form-control  " placeholder="Description" ></textarea>
                        @error('description')
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" maxlength="200" value="{{ old('raised') }}" name="raised" class="form-control  " placeholder="Raised" />
                        @error('raised')
                        <div class="alert alert-danger">
                            <button type="button" class="close" data-dismiss="alert">
                                <i class="ace-icon fa fa-times"></i>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" maxlength="200" value="{{ old('goal') }}" name="goal" class="form-control  " placeholder="Goal" />
                        @error('goal')
                        <div class="alert alert-danger">
                            <button type="button" class="close" data-dismiss="alert">
                                <i class="ace-icon fa fa-times"></i>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" maxlength="200" value="{{ old('success') }}" name="success" class="form-control  " placeholder="Success" />
                        @error('success')
                        <div class="alert alert-danger">
                            <button type="button" class="close" data-dismiss="alert">
                                <i class="ace-icon fa fa-times"></i>
