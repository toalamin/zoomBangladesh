...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>Setup</li>
            <li class="active">Add New Historical Place</li>
        </ul>
        <ul class="breadcrumb pull-right">
            <li>
                <a title="Add New Historical Place" class="financeAddPermission btn btn-sm btn-success" href="{{ route('slider.page') }}">
    ...
    <div class="row">
        <br>
        <div class="col-md-12">
            <form action="{{ route('historical.place.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
