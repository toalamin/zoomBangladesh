...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>Setup</li>
            <li class="active">Add New Month of Employee</li>
        </ul>
        <ul class="breadcrumb pull-right">
            <li>
                <a title="Add New Historical Place" class="financeAddPermission btn btn-sm btn-success" href="{{ route('monthly.index') }}">
    ...
    <div class="row">
        <br>
        <div class="col-md-12">
            <form action="{{ route('monthly.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" name="type">
                            <option value="1">Month Of Employee</option>
                            <option value="2">Year Of Employee</option>
                        </select>
                        @error('employee_id')
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" name="employee_id">
                            ...
                            <option @if(old('employee_id') ==  $value->id) selected @endif value="{{ $value->id }}">{{ $value->full_name }}</option>
                            @endforeach
