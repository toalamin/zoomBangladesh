...
<div class="page-content">
    ...
    <div class="row">
        <br>
        <div class="col-md-12">
            <form action="{{ route('slider.update',$editSlider->id ) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}

                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Title <span style="color:red!important"> *</span></label>
                    <div class="col-sm-6">
                        <input type="text" value="{{ $editSlider->title  }}" name="title" class="form-control  " placeholder="Slider Title" />
                        @error('title')
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <textarea type="text" rows="10" value="" name="description" class="form-control" placeholder="Slider Description..">{{ $editSlider->description }}</textarea>
                        @error('description')
                        <div class="alert alert-danger">
                            <button type="button" class="close" data-dismiss="alert">
                                <i class="ace-icon fa fa-times"></i>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="form-control" name="status">
                            <option @if($editSlider->visibility == 1) selected @endif; value="1">Visible (it will be show)</option>
                            <option @if($editSlider->visibility == 2) selected @endif; value="2">Invisisble(it will be hide)</option>
                        </select>
                        <!-- <div  class="alert alert-danger">
                                    <button type="button" class="close" data-dismiss="alert">
                                        <i class="ace-icon fa fa-times"></i>
