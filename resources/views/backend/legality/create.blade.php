...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>Setup</li>
            <li class="active">Add New Legality</li>
        </ul>
        <ul class="breadcrumb pull-right">
            <li>
                <a title="Add New Legality" class="financeAddPermission btn btn-sm btn-success" href="{{ route('legality.index') }}">
    ...
    <div class="row">
        <br>
        <div class="col-md-12">
            <form action="{{ route('legality.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" value="{{ old('regi_no') }}" name="regi_no" class="form-control  " placeholder="Regi No" />
                        @error('regi_no')
                        <div class="alert alert-danger">
                            <button type="button" class="close" data-dismiss="alert">
                                <i class="ace-icon fa fa-times"></i>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                    <input type="date" value="{{ old('date') }}" name="date" class="form-control  " placeholder="date" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="file" value="" name="file" class="form-control" placeholder="Description.." />
                        @error('file')
                        <div class="alert alert-danger">
                            <button type="button" class="close" data-dismiss="alert">
                                <i class="ace-icon fa fa-times"></i>
