...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>Setup</li>
            <li class="active">Photo Setup</li>
        </ul>
        <ul class="breadcrumb pull-right">
            <li>
                <a title="Add New Slider" class="financeAddPermission btn btn-sm btn-success" href="{{ route('photo.create') }}">
                        ...
                        <tr>
                            ...
                            <td nowrap>
                                <form action="{{ route('photo.destroy',$value->id) }}" method="POST">
                                    <a class="btn btn-xs btn-success blue" href="{{ route('photo.edit',$value->id) }}">
