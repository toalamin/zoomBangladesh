...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>Setup</li>
            <li class="active">Add New Team Caategory</li>
        </ul>
        <ul class="breadcrumb pull-right">
            <li>
                <a title="Add New  Team" class=" btn btn-sm btn-success" href="{{ route('team.index') }}">
        ...
        <div class="col-md-12">
            <form action="{{ route('team.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" value="{{ old('title') }}" name="title" class="form-control  " placeholder="Category Name" />
                        @error('title')
