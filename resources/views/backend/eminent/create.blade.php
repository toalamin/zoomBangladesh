...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb pull-right">
            <li>
                <a title="Add New Historical Place" class="financeAddPermission btn btn-sm btn-success" href="{{ route('eminent.people.page') }}">
    ...
    <div class="row">
        <br>
        <div class="col-md-12">
            <form action="{{ route('eminent.people.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea type="text" value="" name="short_description" class="form-control  " placeholder="Short Description" >{{ old('short_description') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                    <input type="text" value="{{ old('linkedin') }}" name="linkedin" class="form-control  " placeholder="Linkedin Link" />
                    <!-- <textarea class="ckeditor form-control" name="description"></textarea> -->
                        <!-- <textarea type="text" rows="10" value="" name="description" class="form-control" placeholder="Slider Description.."></textarea> -->
                        @error('linkedin')
                        <div class="alert alert-danger">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                    <input type="text" value="{{ old('instagram') }}" name="instagram" class="form-control  " placeholder="instagram Link" />
                    <!-- <textarea class="ckeditor form-control" name="description"></textarea> -->
                        <!-- <textarea type="text" rows="10" value="" name="description" class="form-control" placeholder="Slider Description.."></textarea> -->
                        @error('instagram')
                        <div class="alert alert-danger">
