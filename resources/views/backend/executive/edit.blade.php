...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>Setup</li>
            <li class="active">Edit Executive Committe</li>
        </ul>
    ...
    <div class="row">
        <br>
        <div class="col-md-12">
            <form action="{{ route('executive.committee.update',$committe->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
