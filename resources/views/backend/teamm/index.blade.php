...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb pull-right">
            <li>
                <a title="Add New Team" class="financeAddPermission btn btn-sm btn-success" href="{{ route('teamm.create') }}">
                ...
                <table id="example" class="table table-striped table-bordered table-hover" style="width:100%!important">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="frontant/team/{{ $value->image }}" height="50px" width="50px" /></td>
                            <!-- <td>
                            ...
                            <td nowrap>
                                <form action="{{ route('teamm.destroy',$value->id) }}" method="POST">
                                    <a class="btn btn-xs btn-success blue" href="{{ route('teamm.edit',$value->id) }}">
