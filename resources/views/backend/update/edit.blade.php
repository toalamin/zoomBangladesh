...
<div class="page-content">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb pull-right">
            <li>
                <a title="Add New Update" class="financeAddPermission btn btn-sm btn-success" href="{{ route('update.index') }}">
    ...
    <div class="row">
        <br>
        <div class="col-md-12">
            <form action="{{ route('update.update',$update->id ) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                    <textarea class="ckeditor form-control" name="description">{{ $update->description }}</textarea>
                        @error('description')
                        <div class="alert alert-danger">
                            <button type="button" class="close" data-dismiss="alert">
                                <i class="ace-icon fa fa-times"></i>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" name="status">
                            <option @if($update->visibility == 1) selected @endif; value="1">Visible (it will be show)</option>
                            <option @if($update->visibility == 2) selected @endif; value="2">Invisisble(it will be hide)</option>
                        </select>
                        <!-- <div  class="alert alert-danger">
                                    <button type="button" class="close" data-dismiss="alert">
                                        <i class="ace-icon fa fa-times"></i>
